...
// Make available globally for the addon
if (typeof window !== 'undefined') {
  window.PRIMENG_THEMES = PRIMENG_THEMES;
  window.themeManager = themeManager;
  window.tokensToCSSVars = tokensToCSSVars;
  window.applyCSSVars = applyCSSVars;
}
...
// ES6 export (for Storybook)
export { PRIMENG_THEMES, themeManager, tokensToCSSVars, applyCSSVars, ThemeManager };
